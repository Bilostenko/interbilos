...
1️⃣ "sender": Назва Центрального бюро Інтерполу. Як правило пишеться назва столиці країни, з якої прийшов запит. 

ВАЖЛИВО:
- Якщо у назві є слово INTERPOL (наприклад, "INTERPOL BUDAPEST"), то слово INTERPOL треба прибрати і залишити тільки назву міста.
- Формат завжди: TO: IP [місто великими літерами]. Наприклад: TO: IP BUDAPEST.
...
3️⃣ "date":
-  Знайди рядок, що починається зі слова "Date:" і витягни дату після двокрапки у форматі ДД/ММ/РРРР.
