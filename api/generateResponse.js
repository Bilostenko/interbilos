...
1️⃣ "sender": Назва Центрального бюро Інтерполу. Як правило пишеться назва столиці країни з якої прийшов запит. Напрклад NCB Kyiv чи INTERPOL KYIV. Переклади країну на назву Центрального бюро Інтерполу:
  * УГОРЩИНА → BUDAPEST
  * НІМЕЧЧИНА → WIESBADEN
  * ІТАЛІЯ → ROME
  * ФРАНЦІЯ → PARIS
