...
8️⃣ "attachment_count": кількість файлів, які будуть згадані в кінці документа (рядок Attachment):
- Якщо delete_photo = false → +1
- Якщо delete_border = false → +2 (бо border завжди містить 2 окремих файли)

Отже:
- якщо delete_photo = true і delete_border = true → attachment_count = 0 → рядок Attachment повністю видалити
- якщо лише photo → attachment_count = 1
- якщо лише border → attachment_count = 2
- якщо і photo, і border → attachment_count = 3
