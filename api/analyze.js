...
- "summary": короткий опис змісту документа (контекст, хто кого згадує, що сталося). Якщо в документі згадується будь-яка адреса (місце проживання, прописка, юридична адреса, адреса установи/компанії), ти ОБОВ’ЯЗКОВО маєш додати її до цього поля.
